...
@section('content')
    <div class="container">
        <h2 class="mb-4 text-center">Tambah Item Pesanan Sekolah</h2>
        ...
        <form action="{{ route('item_pesanan_sekolah.store') }}" method="POST">
            @csrf

            <!-- Select Surat Pesanan Sekolah -->
            <div class="card shadow-lg p-3 mb-5 bg-body rounded">
                <div class="card-body ">
                    <div class="row">
                        <div class="col-8">
                            <div class="form-group mb-3">
                                <label for="surat_pesanan_sekolah_id">Surat Pesanan Sekolah</label>
                                <select class="form-control select2" name="surat_pesanan_sekolah_id"
                                    id="surat_pesanan_sekolah_id">
                                    <option value="">Pilih Surat Pesanan</option>
                                    @foreach ($suratPesananSekolahs as $suratPesanan)
                                        <option value="{{ $suratPesanan->id }}">{{ $suratPesanan->nama_sekolah }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
