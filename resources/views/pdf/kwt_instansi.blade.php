...
<body>
    <div class="container">
        ...
        <div class="title-number">NO: {{ $suratPesananInstansi->nomor }}</div>

        <table class="content">
            <tr>
                <td>Telah terima dari</td>
                <td>: {{ $suratPesananInstansi->nama_data }}</td>
            </tr>
            <tr>
                <td>Uang Sejumlah</td>
            ...
            <tr>
                ...
                <td><strong>: {{ $suratPesananInstansi->nama_data }}</strong></td>
            </tr>
            <tr>
                <td colspan="2">
                    <div class="amount">
        ...
        <table class="signatures">
            <tr>
                <td>
                    ...
                    <div>({{ $suratPesananInstansi->nama_pemesan }})</div>
                </td>
                <td>
                    <div>Bendahara</div>
                    <br>
                    ...
                    <br>
                    <div class="signature-line"></div>
                    <div>({{ $suratPesananInstansi->nama_bendahara }})</div>
                </td>
                <td>
