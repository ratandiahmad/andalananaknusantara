    ...
    <div class="invoice-container">
        ...
        <div class="box">
            <div class="invoice-info">
                ...
                <div class="info-cell">
                    ...
                    <div><b>{{ $suratPesananSekolah->nama_sekolah }}</b></div>
                    <div>{{ $suratPesananSekolah->alamat }}</div>
                    <div>{{ $suratPesananSekolah->telepon }}</div>
                </div>
                <div class="info-cell">
                    <div class="info-title">Metode Pembayaran:</div>
                    <div>Bank: {{ $suratPesananSekolah->nama_bank }}</div>
                    <div>Rekening: {{ $suratPesananSekolah->rekening }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="box">
                        ...
                        @foreach ($itemPesananSekolahs as $item)
                            <tr>
                                ...
                                <td style="text-align: center">{{ $item->buku->jenis }} - Kelas
                                    {{ $item->buku->kelas }}</td>
                                <td style="text-align: center">{{ $item->qty_diambil }}</td>
            ...
            <div class="totals">
                @if ($suratPesananSekolah->kategori->nama_kategori == 'Buku')
                    @php
                        $totalBuku = $itemPesananSekolahs->sum(function ($item) {
                ...
                @else
                    @php
                        $totalBarang = $itemPesananSekolahs->sum(function ($item) {
